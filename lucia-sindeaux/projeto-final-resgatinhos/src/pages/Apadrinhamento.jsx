...
const Apadrinhamento = () => {
  ...
  return (
    <>          
      ...
      <p className={styles.headerSteps}><b>Passo 3:</b> Preencha o formulário na página de doação caso você deseje se tornar madrinha ou padrinho de um ou mais gatinhos. Entaremos em contato com você ao recebermos as suas respostas.
      </p>
      </div>
