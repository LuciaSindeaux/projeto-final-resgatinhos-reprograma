...
const Apadrinhamento = () => {
  ...
  return (
    <>          
      ...
      <p className={styles.headerSteps}><b>Passo 3:</b> Envie um e-mail para <b>contato@resgatinhos.com.br</b> se você deseje se tornar madrinha ou padrinho de um ou mais gatinhos. Entaremos em contato com você assim que recebermos o seu e-mail.
      </p>
      </div>
